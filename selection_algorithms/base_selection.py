...
def select_populus(populus, config, selection=True):
    ...
    if method == "boltzmann_selection":
        return boltzmann_selection(selection_size, populus, config['selection_temperature'])
    elif method == "deterministic_tournament_selection":
        return deterministic_tournament_selection(selection_size, populus, config['m_value'])
    elif method == "probabilistic_tournament_selection":
        return probabilistic_tournament_selection(selection_size, populus, config['threshold'])
